...
st.markdown("### Prediction of GDP Growth Rate of Different Countries and Optimization of Fiscal Budgets Using Machine Learning Models (Based on Historical Data)")
st.info(
